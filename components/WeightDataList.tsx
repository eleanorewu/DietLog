...
export const WeightDataList: React.FC<WeightDataListProps> = ({
  ...
  return (
    <div className="flex flex-col p-2 h-full bg-slate-50 animate-slideIn">
      {/* Header */}
        <div className="flex items-center p-4">
            <button 
        onClick={onBack} 
        className="p-2 -ml-2 text-slate-600 rounded-full hover:bg-slate-200"
        >
        <LogOut className="rotate-180" size={24}/>
            </button>
            <h1 className="text-xl font-bold ml-2">體重</h1>
        </div>
          ...
          <div className="space-y-3">
            {weightRecords
              ...
              .map(record => (
                <div 
                  key={record.id} 
                  className="bg-white rounded-xl px-4 py-2 border border-slate-100 "
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-baseline gap-1 mb-1">
                        ...
                        <span className="text-base font-medium text-slate-600">kg</span>
                      </div>
